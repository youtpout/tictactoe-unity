...
/* harmony import */ var _styles_Home_module_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1110);
...
function Home() {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        if (state.accountExists && win.tictactoe) {
            ...
            (_win_tictactoe = win.tictactoe) === null || _win_tictactoe === void 0 ? void 0 : (_win_tictactoe_game = _win_tictactoe.game(canvas, config, ()=>{})) === null || _win_tictactoe_game === void 0 ? void 0 : _win_tictactoe_game.then();
        }
    }, [
        state.accountExists
    ]);
