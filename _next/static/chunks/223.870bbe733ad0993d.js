"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[223,270],{
...
/* harmony export */ });
/* unused harmony exports Board, WinToken, SaveToken */
...
class Board {
    ...
    serialize() {
        ...
        return o1js__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN.fromBits(isPlayed.concat(player));
    }
    update(x, y, playerToken) {
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 3; j++) {
                ...
                this.board[i][j] = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(toUpdate, new OptionalBool(true, playerToken), this.board[i][j]);
            }
        }
    }
    printState() {
...
class GameState extends (0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .Struct */ .AU)({
    ...
    hash() {
        return o1js__WEBPACK_IMPORTED_MODULE_0__/* .Poseidon */ .jm.hash([
            this.player1.x,
...
class WinToken extends o1js__WEBPACK_IMPORTED_MODULE_0__/* .SmartContract */ .C3 {
    ...
    getReward(pubkey1, signature1, pubkey2, signature2, gameState) {
        ...
        o1js__WEBPACK_IMPORTED_MODULE_0__/* .Bool */ .tW.or(pubkey1.equals(player1), pubkey2.equals(player2)).assertTrue();
        ...
        won.assertTrue();
        const winner = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(gameState.nextIsPlayer2, gameState.player1, gameState.player2);
        const signature = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Provable */ .PC.if(gameState.nextIsPlayer2, signature1, signature2);
